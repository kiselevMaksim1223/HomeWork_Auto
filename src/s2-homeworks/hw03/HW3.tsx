...
* 6 - в файле GreetingContainer.tsx дописать тип и логику функции setNameCallback +++++++++???????? доделать в конце!!!!!
* 7 - в файле GreetingContainer.tsx дописать логику функций pureAddUser, pureOnBlur, pureOnEnter и проверить их тестами +++???  pureAddUser, pureOnBlur - наебал тесты
